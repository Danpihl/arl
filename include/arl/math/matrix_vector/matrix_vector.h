...
{
template <typename T>
void Matrix<T>::addVectorToMatrixCols(const Vector<T> &v)
{
...
template <typename T>
void Matrix<T>::addVectorToMatrixRows(const Vector<T> &v)
{
    ASSERT(is_allocated_) << "Matrix not allocated!";
    ASSERT(v.isAllocated()) << "Vector not allocated!";
...
template <typename T>
void Matrix<T>::addVectorToMatrixCols(const Vec4D<T> &v)
{
    this->addVectorToMatrixCols(v.toVector());
}

template <typename T>
void Matrix<T>::addVectorToMatrixRows(const Vec4D<T> &v)
{
    this->addVectorToMatrixRows(v.toVector());
}

template <typename T>
void Matrix<T>::addVectorToMatrixCols(const Vec3D<T> &v)
{
    this->addVectorToMatrixCols(v.toVector());
}

template <typename T>
void Matrix<T>::addVectorToMatrixRows(const Vec3D<T> &v)
{
    this->addVectorToMatrixRows(v.toVector());
}

template <typename T>
void Matrix<T>::addVectorToMatrixCols(const Vec2D<T> &v)
{
    this->addVectorToMatrixCols(v.toVector());
}

template <typename T>
void Matrix<T>::addVectorToMatrixRows(const Vec2D<T> &v)
{
    this->addVectorToMatrixRows(v.toVector());
}

template <typename T>
Vector<T> Matrix<T>::getColumnVector(size_t column_idx) const
{
...
template <typename T>
Vector<T> Matrix<T>::getRowVector(size_t row_idx) const
{
...
template <typename T>
void Matrix<T>::hCat(const Vector<T> &v)
{
    ASSERT(is_allocated_) << "Matrix not allocated!";
    ASSERT(v.isAllocated()) << "Vector not allocated!";
...
template <typename T>
void Matrix<T>::vCat(const Vector<T> &v)
{
    ASSERT(is_allocated_) << "Matrix not allocated!";
    ASSERT(v.isAllocated()) << "Vector not allocated!";
    ASSERT(num_rows_ == v.size()) << "Mismatch in number of cols!";
...
template <typename T>
Matrix<T> hCat(const Matrix<T> &m, const Vector<T> &v)
{
...
template <typename T>
Matrix<T> vCat(const Matrix<T> &m, const Vector<T> &v)
{
    ASSERT(m.isAllocated()) << "Matrix not allocated!";
    ASSERT(v.isAllocated()) << "Vector not allocated!";
...
template <typename T>
Matrix<T> hCat(const Vector<T> &v, const Matrix<T> &m)
{
...
template <typename T>
Matrix<T> vCat(const Vector<T> &v, const Matrix<T> &m)
{
...
template <typename T>
Matrix<T> hCat(const Matrix<T> &m, const Vec4D<T> &v)
{
...
template <typename T>
Matrix<T> vCat(const Matrix<T> &m, const Vec4D<T> &v)
{
    Vector<T> vg = v.toVector();
    return vCat(m, vg);
}
...
template <typename T>
Matrix<T> hCat(const Matrix<T> &m, const Vec3D<T> &v)
{
    Vector<T> vg = v.toVector();
    return hCat(m, vg);
}
...
template <typename T>
Matrix<T> vCat(const Matrix<T> &m, const Vec3D<T> &v)
{
    Vector<T> vg = v.toVector();
    return vCat(m, vg);
}
...
template <typename T>
Matrix<T> hCat(const Matrix<T> &m, const Vec2D<T> &v)
{
    Vector<T> vg = v.toVector();
    return hCat(m, vg);
}
...
template <typename T>
Matrix<T> vCat(const Matrix<T> &m, const Vec2D<T> &v)
{
    Vector<T> vg = v.toVector();
    return vCat(m, vg);
}
...
template <typename T>
Matrix<T> hCat(const Vec4D<T> &v, const Matrix<T> &m)
{
    Vector<T> vg = v.toVector();
    return hCat(vg, m);
}
...
template <typename T>
Matrix<T> vCat(const Vec4D<T> &v, const Matrix<T> &m)
{
    Vector<T> vg = v.toVector();
    return vCat(vg, m);
}
...
template <typename T>
Matrix<T> hCat(const Vec3D<T> &v, const Matrix<T> &m)
{
    Vector<T> vg = v.toVector();
    return hCat(vg, m);
}
...
template <typename T>
Matrix<T> vCat(const Vec3D<T> &v, const Matrix<T> &m)
{
    Vector<T> vg = v.toVector();
    return vCat(vg, m);
}
...
template <typename T>
Matrix<T> hCat(const Vec2D<T> &v, const Matrix<T> &m)
{
    Vector<T> vg = v.toVector();
    return hCat(vg, m);
}
...
template <typename T>
Matrix<T> vCat(const Vec2D<T> &v, const Matrix<T> &m)
{
    Vector<T> vg = v.toVector();
    return vCat(vg, m);
}
...
template <typename T>
Matrix<T> Vector<T>::toColumnVectorMat() const
{
...
template <typename T>
Matrix<T> Vector<T>::toRowVectorMat() const
{
...
template <typename T>
Matrix<T> Vec2D<T>::outerProduct(const Vec2D<T> &v) const
{
...
template <typename T>
Matrix<T> Vec3D<T>::outerProduct(const Vec3D<T> &v) const
{
    Vector<T> vv0 = toVector();
    Vector<T> vv1 = v.toVector();
...
template <typename T>
Vec4D<T> Vector<T>::toVec4D() const
{
...
template <typename T>
Vec3D<T> Vector<T>::toVec3D() const
{
    ASSERT(is_allocated_) << "Error, parent vector not allocated!";
...
template <typename T>
Vec2D<T> Vector<T>::toVec2D() const
{
    ASSERT(is_allocated_) << "Error, parent vector not allocated!";
...
template <typename T>
Matrix<T> Vec4D<T>::outerProduct(const Vec4D<T> &v) const
{
    Vector<T> vv0 = toVector();
    Vector<T> vv1 = v.toVector();
...
template <typename T>
Vector<T> Vec2D<T>::toVector() const
{
...
template <typename T>
Vector<T> Vec3D<T>::toVector() const
{
...
template <typename T>
Vector<T> Vec4D<T>::toVector() const
{
...
template <typename T>
Matrix<T> Vec3D<T>::toCrossProductMatrix() const
{
    Matrix<T> m(3, 3);
    m(0, 0) = 0.0;
    m(0, 1) = -z;
...
template <typename T>
Vec3D<T> crossProductMatrixToVec3D(const Matrix<T> &m)
{

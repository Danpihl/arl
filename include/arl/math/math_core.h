...
template <typename T>
using Point3D = Vec3D<T>;
template <typename T>
using Point4D = Vec4D<T>;
template <typename T>
...
public:
    ...
    template <typename Y>
    Vector<T> operator()(const Vector<Y> &idx_vector) const;
...
template <typename T>
using PolarPoint = PolarVec<T>;
template <typename T>
using SphericalPoint = SphericalVec<T>;
template <typename T>
using CylindricalPoint = CylindricalVec<T>;
...
template <typename T>
Matrix<T> array2x2ToMatrix(const double a[2][2])
{
    Matrix<T> m(2, 2);
...
template <typename T>
Matrix<T> array3x3ToMatrix(const double a[3][3])
{
    Matrix<T> m(3, 3);
...
template <typename T>
Matrix<T> array4x4ToMatrix(const double a[4][4])
{
    Matrix<T> m(4, 4);

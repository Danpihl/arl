...
{
    ASSERT(boost::filesystem::exists(text_file_path)) << "Couldn't find the specified text file: " << text_file_path;
...
{
    ASSERT(boost::filesystem::exists(folder_path)) << "Couldn't find the specified folder path: " << folder_path;
...
{
    ASSERT(boost::filesystem::exists(output_folder_path)) << "Couldn't find the specified path: " << output_folder_path;

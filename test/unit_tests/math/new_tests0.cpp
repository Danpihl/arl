...
TEST_F(NewTest, MatrixMinAlongCols)
{
...
TEST_F(NewTest, MatrixMinAlongRows)
{
    const double eps = 1e-8;
...
TEST_F(NewTest, MatrixMaxAlongCols)
{
    const double eps = 1e-8;
...
TEST_F(NewTest, MatrixMaxAlongRows)
{
    const double eps = 1e-8;
...
TEST_F(NewTest, MatrixSumAlongCols)
{
    const double eps = 1e-8;
...
TEST_F(NewTest, MatrixSumAlongRows)
{
    const double eps = 1e-8;
...
TEST_F(NewTest, Vec3DAxisAngleBetweenVecs)
{
    ...
    const Matrixd tm = {{1, 0, 0}, {0, 1, 0}, {0, 0, 1},
                        ...
                        {1, 0, 1}, {1, 1, 0}, {0, 1, 1},
                        {1, 1, 1}};
    const Vectord v_angles = linspace0(-0.01, 3.0 * M_PI, 5);

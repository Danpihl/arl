...
TEST_F(MatrixFixedTest, HorizontalConcatenationMatrix)
{
    ...
    MatrixFixed<3, 5, int> m2 = {{100, 200, 300, 400, 500}, {400, 500, 600, 700, 800}, {700, 800, 900, 100, 200}};
    MatrixFixed<3, 6, int> m3 = {{1000, 2000, 3000, 4000, 5000, 6000}, {4000, 5000, 6000, 7000, 8000, 9000}, {7000, 8000, 9000, 1000, 2000, 3000}};
...
TEST_F(MatrixFixedTest, VerticalConcatenationMatrix)
{
    ...
    MatrixFixed<5, 3, int> m2 = {{100, 200, 300}, {400, 500, 600}, {700, 800, 900}, {400, 100, 600}, {900, 500, 200}};
